...
export default class ListerMembre extends HTMLElement {
    ...
    static _create = () => {
        ...
        Get('membre').then(data => {
            ...
            _header.innerHTML = 'Liste des Membres';
            ...
            _th.innerHTML = ' <i class="icon_profile"></i>  Matricule ';
            __th.innerHTML = ' <i class="icon_calendar"></i> Nom Complet';
            ___th.innerHTML = '<i class="icon_cogs"></i> Date de Naissance';
    ...
    static _TrTd = (tabs) => {
        ...
        tabs.forEach(element => {
            ...
            date.innerHTML = `${element.date_naisse}`;
