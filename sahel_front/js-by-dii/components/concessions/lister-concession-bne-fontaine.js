...
export default class ListerConcessionByFontaine extends HTMLElement {

    constructor() { super() }

    static _create = () => {
        Get('concession/fontaine').then(result => {
            console.log(result);
    ...
    static _tabsVillages = (data) => {
        ...
        _header.innerHTML = `Liste des Concessions avec des Fontaines`;
