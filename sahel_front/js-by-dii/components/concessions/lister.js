...
export default class ListerConcession extends HTMLElement {
    ...
    static _create = () => {
        ...
        Get('concession').then(data => {
            ...
            _header.innerHTML = 'Liste des Concessions';
            ...
            _th.innerHTML = ' <i class="icon_profile"></i>  Code Concession';
            __th.innerHTML = ' <i class="icon_calendar"></i> Nom Concession';
