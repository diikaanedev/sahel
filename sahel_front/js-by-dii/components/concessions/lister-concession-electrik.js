...
export default class ListerConcessionElectrick extends HTMLElement {

    constructor() { super() }

    static _create = () => {
        Get('concession/electrique').then(result => {
            console.log(result);
    ...
    static _tabsVillages = (data) => {
        ...
        _header.innerHTML = `Liste des Concessions avec Electricité`;
