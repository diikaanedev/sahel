...
export default class ListerCommune extends HTMLElement {
    ...
    static _create = () => {
        ...
        Get('commune').then(data => {
            ...
            _th.innerHTML = ' <i class="icon_profile"></i>  Code Comunne';
            __th.innerHTML = ' <i class="icon_calendar"></i> Nom Comunne';
    ...
    static _TrTd = (tabs) => {
        ...
        tabs.forEach(element => {
            ...
            nom.innerHTML = `${element.nomCommune}`;
