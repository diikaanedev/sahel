...
export default class ListerEquipement extends HTMLElement {
    ...
    static _create = () => {
        ...
        Get('equipement').then(data => {
            ...
            _header.innerHTML = 'Liste des Equipements';
            ...
            _th.innerHTML = ' <i class="icon_profile"></i>  Code Equipement';
            __th.innerHTML = ' <i class="icon_calendar"></i> Designation Equipement';
    ...
    static _TrTd = (tabs) => {
        ...
        tabs.forEach(element => {
            ...
            nom.innerHTML = `${element.nomMateriel}`;
