...
import AddOperateurStocker from "../add-form.js";

export const AddOperateurStockerEvents = e => {
    e.preventDefault();
    const tabs = {
        icon: 'fa fa-plus',
    ...
    BaseTemplate.body(Navbar._create(), Aside._create(), AddOperateurStocker._create() , tabs);
}