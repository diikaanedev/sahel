...
export default class ListerCharge extends HTMLElement {
    ...
    static _create = () => {
        ...
        Get('charge').then(data => {
            ...
            _header.innerHTML = 'Liste des Communes';
            ...
            _th.innerHTML = ' <i class="icon_profile"></i>  Code Charge';
            __th.innerHTML = ' <i class="icon_calendar"></i> Designation Charge';
    ...
    static _TrTd = (tabs) => {
        ...
        tabs.forEach(element => {
            ...
            nom.innerHTML = `${element.designation}`;
