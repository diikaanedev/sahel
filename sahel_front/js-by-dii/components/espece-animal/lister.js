...
export default class ListerEspece extends HTMLElement {
    ...
    static _create = () => {
        ...
        Get('espece').then(data => {
            ...
            _header.innerHTML = 'Liste des Especes';
            ...
            _th.innerHTML = ' <i class="icon_profile"></i>  Code Espece';
            __th.innerHTML = ' <i class="icon_calendar"></i> Designation Espece';
    ...
    static _TrTd = (tabs) => {
        ...
        tabs.forEach(element => {
            ...
            nom.innerHTML = `${element.nomEspece}`;
