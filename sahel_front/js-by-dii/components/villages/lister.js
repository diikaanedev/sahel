...
export default class ListerVillage extends HTMLElement {
    ...
    static _create = () => {
        ...
        Get('village').then(data => {
            ...
            _header.innerHTML = 'Liste des Villages';
            ...
            _th.innerHTML = ' <i class="icon_profile"></i>  Code Village';
            __th.innerHTML = ' <i class="icon_calendar"></i> Nom Village';
