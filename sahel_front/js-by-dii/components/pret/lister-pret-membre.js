...
export default class ListerPretMembre extends HTMLElement {
    constructor() {
        super()
    }
    ...
    static _create = () => {
        ...
        return AddFormHtml('Lister Pret Membre ', tabs ,this.listerPretMembreEvents , 'lister')
    }

    static listerPretMembreEvents = e => {
        ...
        Post('pret/membre' , body).then((result) => {
            console.log(result);
            BaseTemplate.body(Navbar._create(), Aside._create(), this._listerPret(result.structures , result.prets , result.membre));
        }).catch((err) => {
            console.log(err);
        });
    ...
    static _listerPret = (structures , prets , membre) => {
        ...
        Get('pret').then(data => {
            ...
            _header.innerHTML = `Liste des Prets de ce Membre  : ${membre.prenom} ${membre.nom}`;
            ...
            nomMembre.innerHTML = ' <i class="icon_profile"></i> Nom Structure Fianciere';
            ...
            this._TrTd(prets, structures,).forEach(element => {
    ...
    static _TrTd = (prets, structures) => {
        ...
        for (let index = 0; index < prets.length; index++) {
            ...
            nomMembre.innerHTML = `${_structure.nom} `;
