...
export default class ListerDepartement extends HTMLElement {
    ...
    static _create = () => {
        ...
        Get('departement').then(data => {
            ...
            _header.innerHTML = 'Liste des Départements';
            ...
            _th.innerHTML = ' <i class="icon_profile"></i>  Code Départements';
            __th.innerHTML = ' <i class="icon_calendar"></i> Nom Départements';
    ...
    static _TrTd = (tabs) => {
        ...
        tabs.forEach(element => {
            ...
            nom.innerHTML = `${element.nomDepartement}`;
