...
import AddCommercialisation from "../add-form.js";

export const AddCommercialisationEvents = e => {
    e.preventDefault();
    const tabs = {
        icon: 'fa fa-plus',
    ...
    BaseTemplate.body(Navbar._create(), Aside._create(), AddCommercialisation._create() , tabs);
}