...
export default class ListerRegroupement extends HTMLElement {
    ...
    static _create = () => {
        ...
        Get('groupement').then(data => {
            ...
            _header.innerHTML = 'Liste des Regroupements';
            ...
            code.innerHTML = ' <i class="icon_profile"></i>  Code Regroupement';
            nom.innerHTML = ' <i class="icon_calendar"></i> Nom Regroupement';
            nbre_member.innerHTML = ' <i class="icon_calendar"></i> Nombre Membres';
            date.innerHTML = '<i class="icon_cogs"></i> Date';
            params.innerHTML = '<i class="icon_cogs"></i> Paramétres';
    
            _tr.appendChild(code);
            _tr.appendChild(nom);
            _tr.appendChild(nbre_member);
    ...
    static _TrTd = (tabs) => {
        ...
        tabs.forEach(element => {
            ...
            nom.innerHTML = `${element.nomGroupement}`;

            nbre_member.innerHTML = `${element.membres.length}`;
