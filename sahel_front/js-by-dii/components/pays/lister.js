...
export default class ListerPays extends HTMLElement {
    ...
    static _create = () => {
        ...
        Get('contry').then(data => {
            ...
            _header.innerHTML = 'Liste des Pays';
            ...
            _th.innerHTML = ' <i class="icon_profile"></i>  Code Pays';
            __th.innerHTML = ' <i class="icon_calendar"></i> Nom Pays';
