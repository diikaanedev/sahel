...
export default class ListerIntrat extends HTMLElement {
    ...
    static _create = () => {
        ...
        Get('intrat').then(data => {
            ...
            _header.innerHTML = 'Liste des Intrats';
            ...
            _th.innerHTML = ' <i class="icon_profile"></i>  Code Intrat';
            __th.innerHTML = ' <i class="icon_calendar"></i> Designation Intrat';
